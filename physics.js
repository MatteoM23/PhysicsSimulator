...
export function initPhysics() {
    ...
    const leftWall = Matter.Bodies.rectangle(20, window.innerHeight / 2, 40, window.innerHeight, { 
        isStatic: true, 
        render: {
    ...
    const rightWall = Matter.Bodies.rectangle(window.innerWidth - 20, window.innerHeight / 2, 40, window.innerHeight, { 
        isStatic: true, 
        render: {
